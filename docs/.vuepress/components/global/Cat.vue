...
<script>
    ...
    const blackCatUrl = 'https://cdn.jsdelivr.net/gh/QiShaoXuan/live2DModel@1.0.0/live2d-widget-model-hijiki/assets/hijiki.model.json';
    const whiteCatUrl = 'https://cdn.jsdelivr.net/gh/QiShaoXuan/live2DModel@1.0.0/live2d-widget-model-tororo/assets/tororo.model.json';
    export default {
        name: 'Cat',
        data() {
            return {
